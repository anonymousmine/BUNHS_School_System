-- ============================================================
--  DEPED CALENDAR INTEGRATION - DATABASE SETUP
--  Run these SQL statements to enable all dynamic features
-- ============================================================
...
CREATE INDEX IF NOT EXISTS idx_events_search ON events(title, description, location);
CREATE INDEX IF NOT EXISTS idx_events_date_range ON events(event_date, event_date);
...
-- 15. Create view for enhanced event listings
...
-- 17. Populate existing events with proper categories if needed
UPDATE events e 
SET e.category = (
