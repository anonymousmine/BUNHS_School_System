        ...
        <div class="topbar-right">
            ...
            <div class="user-dropdown">
                ...
                <div class="user-menu" role="menu">
                    ...
                    <a href="settings.php" class="user-menu-item" role="menuitem">
                        <i class="fas fa-cog"></i>
                        <span>Settings</span>
                    </a>
                    <div class="user-menu-divider"></div>
                    <a href="/School%20System/admin_account/logout.php" class="user-menu-item logout-item" role="menuitem" onclick="return confirm('Are you sure you want to logout?');">
...
<aside class="sidebar" role="navigation" aria-label="Main navigation">
    ...
    <nav class="menu" role="menu">
        <div class="menu-section">
            ...
            <a href="admins.php" class="menu-item" role="menuitem" aria-label="Admins Management" title="Manage Students">
            ...
            <a href="books.php" class="menu-item" role="menuitem" aria-label="Academic Tracks" title="Manage Academic Tracks">
        ...
        <div class="menu-section">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" role="menu">
                    <a href="announcements/create_announcement.php" class="dropdown-item" data-page="create_announcement.php" role="menuitem" title="Create Announcement">
    ...
    <div class="sidebar-footer">
        ...
        <a href="/School%20System/admin_account/logout.php" class="logout" role="button" aria-label="Logout" title="Logout from system" onclick="return confirm('Are you sure you want to logout?');">
            <i class="fa-solid fa-power-off"></i>
            <span>Logout</span>
        </a>
    </div>
