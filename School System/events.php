        ...
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              ...
              <p class="mb-0">
                “Stay updated with the latest events and activities at Buyoan National High School — where students, teachers, and the
                community come together to celebrate learning, achievement, and school spirit.”
              </p>
            </div>
          </div>
        </div>
