<?php
// ═══════════════════════════════════════════════════════════════════════════════
//  verify_otp_new.php — Admin / Sub-Admin OTP Verification Page (matches BUNHS_School_System(2))
//  Shown after successful credential check in index.php.
//  The OTP was already sent by index.php (action=login_verify_credentials).
//  This page handles: display, verify (action=login_verify_otp), and
//  resend (action=login_resend_otp) via fetch() calls to login_otp_fixed.php.
// ═══════════════════════════════════════════════════════════════════════════════
...
<div class="otp-card">
    ...
    <div class="otp-body" style="position:relative;">
        ...
        <div id="expiredOverlay">
            ...
            <a href="index.php" class="otp-ghost" style="font-size:12px;">
        ...
        <div class="otp-actions">
            ...
            <a href="index.php" class="otp-ghost">
...
<script>
/* ═══════════════════════════════════════════════════════════════════════════
   verify_otp_new.php — Client-Side Logic (matches BUNHS_School_System(2))
   ═══════════════════════════════════════════════════════════════════════════ */
...
async function postToOtpHandler(body) {
    ...
    const res = await fetch('login_otp_fixed.php', { method: 'POST', body: fd });
